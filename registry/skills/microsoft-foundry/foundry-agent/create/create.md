...
If the user hasn't already specified, ask the user directly to collect:
...
2. Ask the user directly to provide values for `.env` variables if placeholders were used.
