...
def validate_skill_details(skill_path):
    ...
    try:
        ...
        if not isinstance(frontmatter, dict):
            return build_result(skill_path, False, "Frontmatter must be a YAML dictionary", has_frontmatter=True)
    except yaml.YAMLError as exc:
        return build_result(skill_path, False, f"Invalid YAML in frontmatter: {exc}", has_frontmatter=True)
