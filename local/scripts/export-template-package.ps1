...
$items = @(
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\config\\integration-surfaces.json"; target = "local\\config\\integration-surfaces.json" },
  [pscustomobject]@{ kind = "file"; source = "README.md"; target = "README.md" },
  [pscustomobject]@{ kind = "file"; source = "README.zh-TW.md"; target = "README.zh-TW.md" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\build-runtime-layer.py"; target = "local\\scripts\\build-runtime-layer.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\lib\\integration_surfaces.py"; target = "local\\scripts\\lib\\integration_surfaces.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\validate-workspace-sensitive-metadata-rules.py"; target = "local\\scripts\\validate-workspace-sensitive-metadata-rules.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\lib\\workspace_sensitive_metadata.py"; target = "local\\scripts\\lib\\workspace_sensitive_metadata.py" },
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\lib\\workspace_boundaries.py"; target = "local\\scripts\\lib\\workspace_boundaries.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\verify-workspace-boundaries.py"; target = "local\\scripts\\verify-workspace-boundaries.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\get-publishability-report.py"; target = "local\\scripts\\get-publishability-report.py" },
  ...
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\build-project-map.py"; target = "local\\scripts\\build-project-map.py" },
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\project-map-runtime.js"; target = "local\\scripts\\project-map-runtime.js" },
  [pscustomobject]@{ kind = "file"; source = "local\\scripts\\project-map-template.html"; target = "local\\scripts\\project-map-template.html" },
  [pscustomobject]@{ kind = "dir"; source = "web\\project-map-ui"; target = "web\\project-map-ui" },
