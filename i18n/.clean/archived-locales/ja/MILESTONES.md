...
- `docs/reviews/EXTERNAL_REVIEW_PACKAGE.md` が審査範囲、読書順、除外項目を定義している
- `docs/reviews/EXTERNAL_REVIEW_COVER_NOTE.md` と `docs/reviews/EXTERNAL_REVIEW_HIGHLIGHTS.md` が reviewer-facing entry docs として使える
