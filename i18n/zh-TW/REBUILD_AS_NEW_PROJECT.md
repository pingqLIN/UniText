...
> 狀態：Active Baseline
> 目的：把目前 UniText repository 轉成乾淨 starter project，而不是把 authoring repo 本身當作新專案。
...
- 機器專屬絕對路徑
- 含真實 IDs、hostnames、redirect URIs 或 runtime paths 的 live workspace-specific Cloudflare baseline references
