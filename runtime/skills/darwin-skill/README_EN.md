...
source_of_truth: registry/skills/darwin-skill/README_EN.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/darwin-skill/README_EN.md`
> Source of truth: `registry/skills/darwin-skill/README_EN.md`
