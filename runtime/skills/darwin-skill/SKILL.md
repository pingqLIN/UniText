...
source_of_truth: registry/skills/darwin-skill/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/darwin-skill/SKILL.md`
> Source of truth: `registry/skills/darwin-skill/SKILL.md`
