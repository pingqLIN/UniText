...
source_of_truth: registry/skills/microsoft-foundry/foundry-agent/create/references/toolbox.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/foundry-agent/create/references/toolbox.md`
> Source of truth: `registry/skills/microsoft-foundry/foundry-agent/create/references/toolbox.md`
