...
source_of_truth: registry/skills/microsoft-foundry/foundry-agent/observe/references/cicd-monitoring.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/foundry-agent/observe/references/cicd-monitoring.md`
> Source of truth: `registry/skills/microsoft-foundry/foundry-agent/observe/references/cicd-monitoring.md`
