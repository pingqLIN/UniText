...
source_of_truth: registry/skills/microsoft-foundry/foundry-agent/observe/references/deploy-and-setup.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/foundry-agent/observe/references/deploy-and-setup.md`
> Source of truth: `registry/skills/microsoft-foundry/foundry-agent/observe/references/deploy-and-setup.md`
