...
source_of_truth: registry/skills/microsoft-foundry/foundry-agent/deploy/deploy.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/foundry-agent/deploy/deploy.md`
> Source of truth: `registry/skills/microsoft-foundry/foundry-agent/deploy/deploy.md`
