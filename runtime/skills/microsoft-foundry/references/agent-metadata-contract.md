...
source_of_truth: registry/skills/microsoft-foundry/references/agent-metadata-contract.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/references/agent-metadata-contract.md`
> Source of truth: `registry/skills/microsoft-foundry/references/agent-metadata-contract.md`
