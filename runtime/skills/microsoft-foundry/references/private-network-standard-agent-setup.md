...
source_of_truth: registry/skills/microsoft-foundry/references/private-network-standard-agent-setup.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/microsoft-foundry/references/private-network-standard-agent-setup.md`
> Source of truth: `registry/skills/microsoft-foundry/references/private-network-standard-agent-setup.md`
