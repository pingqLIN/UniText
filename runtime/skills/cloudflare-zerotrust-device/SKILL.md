...
> First-read entrypoint: `runtime/skills/cloudflare-zerotrust-device/SKILL.md`
> Source of truth: `registry/skills/cloudflare-zerotrust-device/SKILL.md`
...
- Use [cloudflare-governance](../../../registry/skills/cloudflare-governance/SKILL.md) first for broad Cloudflare requests.
...
5. Route to a narrower Cloudflare skill once the active change surface is clear.
   - Access app, OAuth, DCR, or redirect URIs -> [cloudflare-access-mcp](../../../registry/skills/cloudflare-access-mcp/SKILL.md)
   - Tunnel ingress, hostnames, or health routing -> [cloudflare-tunnel-dns](../../../registry/skills/cloudflare-tunnel-dns/SKILL.md)
   - WAF, browser check, bot rules, or skip rules -> [cloudflare-edge-security](../../../registry/skills/cloudflare-edge-security/SKILL.md)
   - Runtime split and local TB2 service state -> [cloudflare-runtime-sync](../../../registry/skills/cloudflare-runtime-sync/SKILL.md)
