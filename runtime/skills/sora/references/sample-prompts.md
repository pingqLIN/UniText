...
source_of_truth: registry/skills/sora/references/sample-prompts.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/sora/references/sample-prompts.md`
> Source of truth: `registry/skills/sora/references/sample-prompts.md`
