...
source_of_truth: registry/skills/sora/references/cli.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/sora/references/cli.md`
> Source of truth: `registry/skills/sora/references/cli.md`
