...
source_of_truth: registry/skills/sora/references/codex-network.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/sora/references/codex-network.md`
> Source of truth: `registry/skills/sora/references/codex-network.md`
