...
source_of_truth: registry/skills/claude-design-playbook/references/design-md-structure.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/claude-design-playbook/references/design-md-structure.md`
> Source of truth: `registry/skills/claude-design-playbook/references/design-md-structure.md`
