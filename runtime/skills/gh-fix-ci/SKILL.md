...
source_of_truth: registry/skills/gh-fix-ci/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/gh-fix-ci/SKILL.md`
> Source of truth: `registry/skills/gh-fix-ci/SKILL.md`
