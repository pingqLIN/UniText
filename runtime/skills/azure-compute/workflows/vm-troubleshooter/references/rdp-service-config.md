...
source_of_truth: registry/skills/azure-compute/workflows/vm-troubleshooter/references/rdp-service-config.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-compute/workflows/vm-troubleshooter/references/rdp-service-config.md`
> Source of truth: `registry/skills/azure-compute/workflows/vm-troubleshooter/references/rdp-service-config.md`
