...
source_of_truth: registry/skills/start-chrome-extension-project/references/audit-rules.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/start-chrome-extension-project/references/audit-rules.md`
> Source of truth: `registry/skills/start-chrome-extension-project/references/audit-rules.md`
