...
source_of_truth: registry/skills/gcp-service-adoption/references/project-selection.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/gcp-service-adoption/references/project-selection.md`
> Source of truth: `registry/skills/gcp-service-adoption/references/project-selection.md`
