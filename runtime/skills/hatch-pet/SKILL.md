...
source_of_truth: registry/skills/hatch-pet/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/hatch-pet/SKILL.md`
> Source of truth: `registry/skills/hatch-pet/SKILL.md`
