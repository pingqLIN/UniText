...
source_of_truth: registry/skills/hatch-pet/references/animation-rows.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/hatch-pet/references/animation-rows.md`
> Source of truth: `registry/skills/hatch-pet/references/animation-rows.md`
