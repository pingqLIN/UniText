...
source_of_truth: registry/skills/terminal-layout-dual-pane/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/terminal-layout-dual-pane/SKILL.md`
> Source of truth: `registry/skills/terminal-layout-dual-pane/SKILL.md`
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "$env:USERPROFILE\.codex\skills\terminal-layout-dual-pane\scripts\apply-dual-pane-layout.ps1"
```
...
Use [scripts/apply-dual-pane-layout.ps1](scripts/apply-dual-pane-layout.ps1) for the actual automation.
