...
source_of_truth: registry/skills/webapp-testing/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/webapp-testing/SKILL.md`
> Source of truth: `registry/skills/webapp-testing/SKILL.md`
