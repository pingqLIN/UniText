...
source_of_truth: registry/skills/azure-cloud-migrate/references/services/functions/code-migration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-cloud-migrate/references/services/functions/code-migration.md`
> Source of truth: `registry/skills/azure-cloud-migrate/references/services/functions/code-migration.md`
