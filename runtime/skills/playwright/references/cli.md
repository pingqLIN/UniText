...
source_of_truth: registry/skills/playwright/references/cli.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/playwright/references/cli.md`
> Source of truth: `registry/skills/playwright/references/cli.md`
