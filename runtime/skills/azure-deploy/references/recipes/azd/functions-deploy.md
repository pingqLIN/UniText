...
source_of_truth: registry/skills/azure-deploy/references/recipes/azd/functions-deploy.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-deploy/references/recipes/azd/functions-deploy.md`
> Source of truth: `registry/skills/azure-deploy/references/recipes/azd/functions-deploy.md`
