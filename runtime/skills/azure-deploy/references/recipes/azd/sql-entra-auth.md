...
source_of_truth: registry/skills/azure-deploy/references/recipes/azd/sql-entra-auth.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-deploy/references/recipes/azd/sql-entra-auth.md`
> Source of truth: `registry/skills/azure-deploy/references/recipes/azd/sql-entra-auth.md`
