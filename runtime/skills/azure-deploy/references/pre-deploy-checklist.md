...
source_of_truth: registry/skills/azure-deploy/references/pre-deploy-checklist.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-deploy/references/pre-deploy-checklist.md`
> Source of truth: `registry/skills/azure-deploy/references/pre-deploy-checklist.md`
