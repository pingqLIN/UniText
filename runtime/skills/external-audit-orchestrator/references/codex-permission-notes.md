...
> First-read entrypoint: `runtime/skills/external-audit-orchestrator/references/codex-permission-notes.md`
> Source of truth: `registry/skills/external-audit-orchestrator/references/codex-permission-notes.md`
