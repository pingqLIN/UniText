...
source_of_truth: registry/skills/external-audit-orchestrator/references/mode-codex-exec.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/external-audit-orchestrator/references/mode-codex-exec.md`
> Source of truth: `registry/skills/external-audit-orchestrator/references/mode-codex-exec.md`
