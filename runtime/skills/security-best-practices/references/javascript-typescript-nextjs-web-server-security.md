...
source_of_truth: registry/skills/security-best-practices/references/javascript-typescript-nextjs-web-server-security.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/security-best-practices/references/javascript-typescript-nextjs-web-server-security.md`
> Source of truth: `registry/skills/security-best-practices/references/javascript-typescript-nextjs-web-server-security.md`
