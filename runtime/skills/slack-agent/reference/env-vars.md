...
source_of_truth: registry/skills/slack-agent/reference/env-vars.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/reference/env-vars.md`
> Source of truth: `registry/skills/slack-agent/reference/env-vars.md`
