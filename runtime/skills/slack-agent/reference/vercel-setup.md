...
source_of_truth: registry/skills/slack-agent/reference/vercel-setup.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/reference/vercel-setup.md`
> Source of truth: `registry/skills/slack-agent/reference/vercel-setup.md`
