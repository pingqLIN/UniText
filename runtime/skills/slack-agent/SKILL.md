...
source_of_truth: registry/skills/slack-agent/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/SKILL.md`
> Source of truth: `registry/skills/slack-agent/SKILL.md`
