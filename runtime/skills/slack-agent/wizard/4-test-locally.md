...
source_of_truth: registry/skills/slack-agent/wizard/4-test-locally.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/wizard/4-test-locally.md`
> Source of truth: `registry/skills/slack-agent/wizard/4-test-locally.md`
