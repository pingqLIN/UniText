...
source_of_truth: registry/skills/slack-agent/wizard/5-deploy-production.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/wizard/5-deploy-production.md`
> Source of truth: `registry/skills/slack-agent/wizard/5-deploy-production.md`
