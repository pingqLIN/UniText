...
source_of_truth: registry/skills/slack-agent/wizard/3-configure-environment.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/slack-agent/wizard/3-configure-environment.md`
> Source of truth: `registry/skills/slack-agent/wizard/3-configure-environment.md`
