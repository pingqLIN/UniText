...
source_of_truth: registry/skills/supabase-hosted-admin-oauth/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/supabase-hosted-admin-oauth/SKILL.md`
> Source of truth: `registry/skills/supabase-hosted-admin-oauth/SKILL.md`
