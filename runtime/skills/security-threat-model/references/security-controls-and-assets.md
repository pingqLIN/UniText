...
source_of_truth: registry/skills/security-threat-model/references/security-controls-and-assets.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/security-threat-model/references/security-controls-and-assets.md`
> Source of truth: `registry/skills/security-threat-model/references/security-controls-and-assets.md`
