...
source_of_truth: registry/skills/security-threat-model/references/prompt-template.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/security-threat-model/references/prompt-template.md`
> Source of truth: `registry/skills/security-threat-model/references/prompt-template.md`
