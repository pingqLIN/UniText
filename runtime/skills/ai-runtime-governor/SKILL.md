...
source_of_truth: registry/skills/ai-runtime-governor/SKILL.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/ai-runtime-governor/SKILL.md`
> Source of truth: `registry/skills/ai-runtime-governor/SKILL.md`
...
```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\inventory.ps1
```

### 2) Backup only

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\backup.ps1 -Scope all
```

### 3) Simulate unification (no system changes)

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\apply-path-unify.ps1 -Scope all
```

### 4) Apply unification (real changes)

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\apply-path-unify.ps1 -Scope all -Apply
```

### 5) Drift audit

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\audit-drift.ps1
```

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\audit-drift.ps1 -UpdateBaseline
```

### 6) Change one setting key

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\set-setting.ps1 -Program codex -Key model_reasoning_effort -Value medium
```

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\set-setting.ps1 -Program codex -Key model_reasoning_effort -Value medium -Apply
```

### 7) Enable governance guard (scheduled drift audit)

```powershell
pwsh -File C:\Dev\AI_UNIFIED\skills\ai-runtime-governor\scripts\install-guard-task.ps1 -Mode enable
```
...
- Require all future config edits to be executed through this skill scripts
