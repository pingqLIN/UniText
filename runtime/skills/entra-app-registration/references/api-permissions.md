...
source_of_truth: registry/skills/entra-app-registration/references/api-permissions.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/entra-app-registration/references/api-permissions.md`
> Source of truth: `registry/skills/entra-app-registration/references/api-permissions.md`
