...
source_of_truth: registry/skills/impeccable/reference/brand.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/impeccable/reference/brand.md`
> Source of truth: `registry/skills/impeccable/reference/brand.md`
