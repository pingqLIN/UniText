...
source_of_truth: registry/skills/cloudflare-deploy/references/terraform/configuration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/terraform/configuration.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/terraform/configuration.md`
