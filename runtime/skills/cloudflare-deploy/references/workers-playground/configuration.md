...
source_of_truth: registry/skills/cloudflare-deploy/references/workers-playground/configuration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/workers-playground/configuration.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/workers-playground/configuration.md`
