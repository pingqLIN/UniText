...
source_of_truth: registry/skills/cloudflare-deploy/references/sandbox/api.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/sandbox/api.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/sandbox/api.md`
