...
source_of_truth: registry/skills/cloudflare-deploy/references/api-shield/patterns.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/api-shield/patterns.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/api-shield/patterns.md`
