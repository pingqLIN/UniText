...
source_of_truth: registry/skills/cloudflare-deploy/references/api-shield/configuration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/api-shield/configuration.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/api-shield/configuration.md`
