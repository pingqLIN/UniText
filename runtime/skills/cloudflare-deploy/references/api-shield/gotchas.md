...
source_of_truth: registry/skills/cloudflare-deploy/references/api-shield/gotchas.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/api-shield/gotchas.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/api-shield/gotchas.md`
