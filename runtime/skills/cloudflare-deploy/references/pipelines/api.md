...
source_of_truth: registry/skills/cloudflare-deploy/references/pipelines/api.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/pipelines/api.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/pipelines/api.md`
