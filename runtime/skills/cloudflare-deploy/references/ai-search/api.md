...
source_of_truth: registry/skills/cloudflare-deploy/references/ai-search/api.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/ai-search/api.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/ai-search/api.md`
