...
source_of_truth: registry/skills/cloudflare-deploy/references/secrets-store/README.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/secrets-store/README.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/secrets-store/README.md`
