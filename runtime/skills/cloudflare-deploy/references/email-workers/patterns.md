...
source_of_truth: registry/skills/cloudflare-deploy/references/email-workers/patterns.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/email-workers/patterns.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/email-workers/patterns.md`
