...
source_of_truth: registry/skills/cloudflare-deploy/references/email-workers/gotchas.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/email-workers/gotchas.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/email-workers/gotchas.md`
