...
source_of_truth: registry/skills/cloudflare-deploy/references/realtimekit/api.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/realtimekit/api.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/realtimekit/api.md`
