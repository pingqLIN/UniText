...
source_of_truth: registry/skills/cloudflare-deploy/references/r2-data-catalog/api.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/r2-data-catalog/api.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/r2-data-catalog/api.md`
