...
source_of_truth: registry/skills/cloudflare-deploy/references/pages/configuration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/pages/configuration.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/pages/configuration.md`
