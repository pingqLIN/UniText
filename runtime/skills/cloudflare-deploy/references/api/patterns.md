...
source_of_truth: registry/skills/cloudflare-deploy/references/api/patterns.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/api/patterns.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/api/patterns.md`
