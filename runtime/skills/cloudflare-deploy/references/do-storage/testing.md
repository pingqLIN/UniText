...
source_of_truth: registry/skills/cloudflare-deploy/references/do-storage/testing.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/do-storage/testing.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/do-storage/testing.md`
