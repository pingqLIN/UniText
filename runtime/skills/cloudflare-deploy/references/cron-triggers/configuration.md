...
source_of_truth: registry/skills/cloudflare-deploy/references/cron-triggers/configuration.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/cron-triggers/configuration.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/cron-triggers/configuration.md`
