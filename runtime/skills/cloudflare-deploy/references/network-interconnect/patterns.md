...
source_of_truth: registry/skills/cloudflare-deploy/references/network-interconnect/patterns.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/cloudflare-deploy/references/network-interconnect/patterns.md`
> Source of truth: `registry/skills/cloudflare-deploy/references/network-interconnect/patterns.md`
