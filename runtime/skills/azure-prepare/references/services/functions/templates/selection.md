...
source_of_truth: registry/skills/azure-prepare/references/services/functions/templates/selection.md
---

> Runtime projection for consumer agents.
> First-read entrypoint: `runtime/skills/azure-prepare/references/services/functions/templates/selection.md`
> Source of truth: `registry/skills/azure-prepare/references/services/functions/templates/selection.md`
...
7. Is it for orchestration or workflows?
   ...
   References: [durable.md](../durable.md) for storage backend rules,
